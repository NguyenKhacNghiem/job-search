...
<head>
    ...
    <title>Đăng ký tài khoản dành cho người tìm việc</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 col-12 text-center" style="background-color: #EAF2FC;">
                <img class="img-fluid mt-5" src="./img/register-client.gif">
            </div>

            <div class="col-md-6 col-12 pl-5 pl-md-2">
                <a href="index.php"><img class="img-fluid" src="./img/logo-white.png"></a>
                <h2 class="blue-text">Chào mừng bạn đến với VnJobFind</h2>
                <h5>Đăng ký ngay để tìm kiếm cơ hội việc làm cho tương lai</h5>
                <form novalidate>
                    <div class="form-group">
                        <label for="name" class="blue-text">
                            <h5>Họ và tên</h5>
                        </label>
                        <div class="input-group ">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-white text-dark"><i class="fa-solid fa-user"></i></span>
                            </div>
                            <input type="text" class="form-control shadow-none" id="name" placeholder="Nhập họ và tên của bạn">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group ">
                            ...
                            <input type="email" class="form-control shadow-none" id="email" placeholder="Nhập email của bạn">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-white text-dark"><i class="fa-solid fa-lock"></i></span>
                            </div>
                    ...
                    <p>Bạn là nhà tuyển dụng? <a href="register-company.php" class="blue-text">Đăng ký tại đây</a></p>
                </form>
            </div>
